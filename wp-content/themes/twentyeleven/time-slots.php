...
<div id="form_container">
    <h1><a>Time Slots</a></h1>
    <form id="form_284569" class="appnitro"  method="post" action="<?php $path = get_bloginfo('template_directory');echo $path; ?>/eventproc.php">
        <div class="form_description">
            <h2>Time Slots</h2>
            <p>Fill out the following details to let us know about your free time slots</p>
        </div>						
        <ul >
            <li id="li_5" >
