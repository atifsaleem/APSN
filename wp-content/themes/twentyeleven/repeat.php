...
$j(".month-repeat").css("display","inline");
		...
		<div>
		<select class="element select medium" id="howoften" name="element_5" onchange="changeRecurrence();"> 
...
<option value="3" id="monthly">Monthly</option>
		...
		</li>		<li id="li_6-1" class="repeat-days" style="display:none;">
...
<label class="choice" for="element_6_7">Friday</label>
		...
		</li>		<li id="li_7" class="repeat-weeks" style="display:none;">
