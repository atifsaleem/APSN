...
if ($queueNum >= $event_detail->vacancies) {
    ...
    */
    $queueNum += 1;
    $wpdb->get_results("INSERT INTO signedup_volunteers (`eventID`, `volunID`,`status`,`queueNum`) VALUES ('$eventID', '$email','wait','$queueNum')");
    ...
    $queueNum+=1;
    $wpdb->get_results("INSERT INTO signedup_volunteers (`eventID`, `volunID`,`status`,`queueNum`) VALUES ('$eventID', '$email','confirmed','$queueNum')");
